...
type SavedVideosPageProps = {
  storageKey: string;
  title: string;
  emptyMessage: string;
};

const SavedVideosPage = ({ storageKey, title, emptyMessage }: SavedVideosPageProps) => {
  ...
  return (
    <main className="mx-auto max-w-7xl p-6">
      ...
      {loading ? (
        ...
        <p className="py-10 text-center text-gray-500">{emptyMessage}</p>
      ) : (
